export const juniorDevProjectList = [
	{
		id: 1,
		title: 'My Fun City',
		description: 'The MyFunCity project is a complete campaign to collect and analyze data from various target audiences via a mobile application to create a product that governments and businesses can use to track issues in people\'s environments and deliver ideas to help solve depression and anxiety issues. ',
		ideaDescription: 'The project aims to bring people together in their community to identify and solve daily problems that may affect our lives. Still, because we are always busy and occupied, we need help to change our neighbourhood. In those moments, one might wonder, "How can I make MY CITY better, more efficient, and more FUN?"\n' +
...
export const designerProjectList = [
	{
		...
		description: '- BR Mania, one of the largest 24-hour petrol station networks in Brazil, launched a campaign with' +
		...
		ideaDescription: '- The central idea behind the campaign revolved around the notion that BR Mania serves as more' +
		...
		features: [],
		techStack: ['/assets/project_images/icons_images/ai.png', '/assets/project_images/icons_images/ps.png', '/assets/project_images/icons_images/id.png'],
		images: ['/assets/project_images/br_mania/1.png', '/assets/project_images/br_mania/2.jpg',],
	...
	},
	{
		...
		description: 'The public transportation of São Paulo, Brazil, is hosting a cultural competition campaign. The' +
			' expression "Painting a new subway" in portuguese, suggests that "a new idea is coming".',
		ideaDescription: 'The call for participation invites individuals to submit their creative graphic proposals for' +
		...
		features: [],
		techStack: ['/assets/project_images/icons_images/ai.png', '/assets/project_images/icons_images/ps.png', '/assets/project_images/icons_images/id.png'],
		images: ['/assets/project_images/metro/1.png', '/assets/project_images/metro/2.png', '/assets/project_images/metro/3.png', '/assets/project_images/metro/4.png'],
		projectIcon: '/icons/behance.svg',
		linkTitle: 'See the project on behance',
	...
	},
	{
		...
		description: 'The design project entails creating a comprehensive stationary pack, which encompasses various elements such as a logo guideline, business card, brochure, and more.',
		ideaDescription: 'The design project involves developing an extensive stationary pack that encompasses a range' +
		...
		features: [],
		techStack: ['/assets/project_images/icons_images/ai.png', '/assets/project_images/icons_images/ps.png', '/assets/project_images/icons_images/id.png'],
		images: ['/assets/project_images/santa_rita/1.png', '/assets/project_images/santa_rita/2.png', '/assets/project_images/santa_rita/3.png', "/assets/project_images/santa_rita/4.png", "/assets/project_images/santa_rita/5.png"],
		projectIcon: '/icons/behance.svg',
		linkTitle: 'See the project on behance',
	...
	},
	{
		...
		description: 'The "Festa de Peão," which translates to Cowboy Party, is a lively Brazilian event centered around a country theme. It offers attendees the opportunity to indulge in traditional cuisine and immerse themselves in the vibrant sounds of typical music.',
		ideaDescription: 'he lively and spirited CowParty event not only promises a thrilling experience filled with' +
		...
		features: [],
		techStack: ['/assets/project_images/icons_images/ai.png', '/assets/project_images/icons_images/ps.png', '/assets/project_images/icons_images/id.png'],
		images: ['/assets/project_images/peao/1.png', "/assets/project_images/peao/5.png", "/assets/project_images/peao/4.png", "/assets/project_images/peao/2.png", "/assets/project_images/peao/3.png",],
		projectIcon: '/icons/behance.svg',
		linkTitle: 'See the project on behance',
	...
	},
	{
		...
		description: 'e-Club is an innovative online entertainment center designed exclusively for children. It functions as a virtual school that provides educational support, engaging lessons, and stimulating activities, ensuring that kids are occupied and entertained while their parents attend to their responsibilities.',
		ideaDescription: 'At e-Club, children can delve into a variety of subjects and topics, exploring a diverse range' +
		...
		features: [],
		techStack: ['/assets/project_images/icons_images/ai.png', '/assets/project_images/icons_images/ps.png', '/assets/project_images/icons_images/id.png'],
		images: ['/assets/project_images/e-club/02.png', '/assets/project_images/e-club/03.png', '/assets/project_images/e-club/04.png', '/assets/project_images/e-club/05.png', '/assets/project_images/e-club/07.png'],
		projectIcon: '/icons/behance.svg',
		linkTitle: 'See the project on behance',
	...
	},
	{
		id: 6,
		title: 'Art on Site',
		description: '"Arte na obra" that stands for "Art on Site" was an integral component of the larger campaign' +
		...
		ideaDescription: 'Art on Site is a captivating project that forms an essential part of the larger "Painting a' +
		...
		features: [],
		techStack: ['/assets/project_images/icons_images/ai.png', '/assets/project_images/icons_images/ps.png', '/assets/project_images/icons_images/id.png'],
		images: ['/assets/project_images/art_na_obra/1.png', '/assets/project_images/art_na_obra/2.png', '/assets/project_images/art_na_obra/3.png', '/assets/project_images/art_na_obra/4.png'],
		projectIcon: '/icons/behance.svg',
		linkTitle: 'See the project on behance',
